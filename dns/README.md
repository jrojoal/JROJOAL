...
```
# Servidors web
10.0.1.10 web01.upf.edu
10.0.1.11 web02.upf.edu
10.0.1.12 web03.upf.edu

# Bases de dades
db-master.upf.edu 10.0.2.20
db-slave.upf.edu 10.0.2.21

# Servidors d'aplicacions
10.0.3.30 app01.upf.edu
10.0.3.31 app02.upf.edu
```
...
- Demana el nom de la zona (ex: `upf.edu`)
- Crea el fitxer `upf.edu.hosts`
...
**Format de Backups:**
- Zones forward: `zona.upf.edu.hosts.YYYYMMDD`
...
```
# Contingut de upf.edu.hosts
10.0.1.10	server01.upf.edu
10.0.1.11	server02.upf.edu
10.0.2.20	web01.upf.edu
```
...
```
10.0.1.100 srv-app01.upf.edu
10.0.1.101 srv-app02.upf.edu
10.0.1.102 srv-app03.upf.edu
```
...
Resultat:
- Es creen 3 registres A a `upf.edu.hosts`
...
```
10.0.1.50 old-srv01.upf.edu
10.0.1.51 old-srv02.upf.edu
```
...
Script desenvolupat per automatitzar la gestió DNS a UPF.
